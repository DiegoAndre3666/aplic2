	    	...
	    	<div class="card blue-grey darken-1">
				<div class="card-content white-text">
                    <span class="card-title">Consultas e Relatórios</span>
		     			<a href="listaequipamento.php" class="waves-effect waves-light btn-large"><i class="material-icons left">assignment_ind</i>Relatório geral de Equipamentos</a><br><br>
